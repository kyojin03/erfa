...
3. Maintain each employee's active state, application access, department, and position. New RFA routes draw from the active employee directory; an employee's approval stage is chosen per RFA, not as a permanent role.
